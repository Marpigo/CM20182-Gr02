...
public class Constantes {
    ...
    public static final String CREATE_FOOD_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLA_COMIDA + " (" + CAMPO_ID_C + " INTEGER, " + CAMPO_NAME_C + " TEXT, " + CAMPO_HORARIO_C + " TEXT, " + CAMPO_TIPO_C + " TEXT, " + CAMPO_TIME_C + " TEXT, " + CAMPO_PRECIO_C + " INTEGER, " + CAMPO_INGREDIENTES_C + " TEXT, " + CAMPO_PHOTO_C + " BLOB)";
    ...
    public static final String CREATE_DRINK_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLA_BEBIDA + " (" + CAMPO_ID_B + " INTEGER, " + CAMPO_NAME_B + " TEXT, " + CAMPO_PRECIO_B + " INTEGER, " + CAMPO_INGREDIENTES_B + " TEXT, " + CAMPO_PHOTO_B + " BLOB)";
